...
let hupData = [
    ...
    { text:"The BUP 2x1 and 3x1 effect slightly adds to the Decrementy gain exponent", cost: 1e50, effect: ()=> data.hierarchies.hasUpgrade[4] ? bup48Effect()/(Math.max(1, Decimal.log10(data.chal.decrementy.plus(1)))) : 0 },
