...
let hierarchyData = [
    ...
    { text:"Dividing Charge Requirement by", effect: ()=> Decimal.max((Decimal.log10(effectiveSGH().add(1)).times(hbData[4].effect()).times(getAlephEffect(5))).times(getPringleEffect(6)).pow(dupEffect(2).plus(getBUPEffect(9))), 1),
...
let hierarchyGainGlobalMults = () =>
    hupData[2].effect()*hupData[7].effect()*hbData[0].effect()*hbData[5].effect()*getOverflowEffect(1, 0)
    *purificationEffect(2)*getAlephNullEffect(2)
