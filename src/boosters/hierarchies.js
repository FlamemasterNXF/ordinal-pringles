...
let hupData = [
    ...
    { text:"The BUP 2x1 and 3x1 effect divided by 1000 adds to the Decrementy gain exponent", cost: 1e50, effect: ()=> data.hierarchies.hasUpgrade[4] ? bup48Effect()/1000 : 0 },
