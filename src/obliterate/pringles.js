let pringleData = [
...

    {
        ...
        sign: 'x',
        eff: () => D(10).pow(data.obliterate.pringleAmount[3]).times(getEUPEffect(3, 0)),
        baseValue: 1,
    ...
    },
    {
        ...
        sign: 'x',
        eff: () => D(data.obliterate.pringleAmount[4]**2).times(getEUPEffect(3, 0)),
        baseValue: 1,
        resNames: 'Booster Power',
        resLocation: [['overflow', 'bp']],
...

    {
        ...
        sign: 'x',
        eff: () => D(data.obliterate.pringleAmount[6]+(data.obliterate.pringleAmount[6]/10)).times(getEUPEffect(3, 1)),
        baseValue: 1,
        resNames: 'Cardinals',
     ...
     */
    {
        ...
        sign: 'x',
        eff: () => D(data.obliterate.pringleAmount[7]**2).times(getEUPEffect(3, 1)),
        baseValue: 1,
        resNames: 'Cardinals',
        resLocation: [['collapse', 'cardinals']],
