...
let singFunctions = [
    ...
    {requiredLevel: 50, hasUnlock: true, unlockDescription: 'Double the effect of IUP4', hasEffect: true, effectDescription: 'RUP2 multiplies Dynamic Cap (at an extremely reduced rate) by', effect: () => Math.min(Math.max(1, Decimal.log10(iup2Effect()).toNumber()), Number.MAX_VALUE)},
