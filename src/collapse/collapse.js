...
let sluggishData = [
    ...
    {text: "Unlock an AutoBuyer for Repeatable Hierarchy Upgrades, AutoPrestigers for Factor Shift and Factor Boost, keep UP1-6 on Collapse, and unlock a new row of Booster Upgrades", req: 12},
