/*
        \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
        BASED ON https://github.com/IvarK/AntimatterDimensionsSourceCode/blob/master/src/core/word-shift.js
        ///////////////////////////////////////////////////////////////////////////////////////////////////
*/

function blendWordsRand(x) {
...
function randomCrossWords(str, frac = 0.7) {
    ...
    for (let i = 0; i < x.length * frac; i++) {
        const randomIndex = Math.floor(blendWordsRand(Math.floor(Date.now() / 500) % 964372 + 1.618 * i) * x.length);
