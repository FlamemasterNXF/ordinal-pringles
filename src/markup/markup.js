...
function updateMarkupHTML(){
    ...
    DOM("markupButton").innerHTML =
        ...
        data.ord.ordinal.gte(data.ord.base**2)?`Markup and gain ${formatWhole(opGain()*opMult())} Ordinal Powers (I)`:`${ordinalDisplay("H", data.ord.base**2, 0, data.ord.base, hierarchiesTrim(), false)}(${data.ord.base}) is required to Markup...`
