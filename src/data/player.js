...
function getDefaultPlayer() {
    return {
        ...
        markup: { powers:D(0), shifts:0, successorClicks:0 },
        ...
        darkness: { bestDecrementy: D(0), levels: Array(3).fill(0), negativeCharge:0, drains: Array(7).fill(0), currentLight: 0, bestEntropy: 0, totalDrains: 0, negativeChargeSpent:0, depth: 0, bestDepth: 1, negativeChargeEnabled:false, darkened:false },
        ...
        // Obliteration
        obliterate: { times:0, energy:0, passiveEnergy:0, energyUpgrades: [], pringleAmount: Array(10).fill(0), pringleBuymax: false, hasPassiveUpgrade: Array(passiveUpgradeData.length).fill(false) },
