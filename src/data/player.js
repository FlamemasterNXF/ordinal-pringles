...
function getDefaultPlayer() {
    return {
        ...
        hyper: { hasUpgrade: Array(hyperChargeUpgradeData.length).fill(false), isUpgradeSecondary: Array(hyperChargeUpgradeData.length).fill(false), secondaryInputCost: Array(hyperChargeUpgradeData.length).fill(0), shouldForceStable: Array(hyperChargeUpgradeData.length).fill(false) },
