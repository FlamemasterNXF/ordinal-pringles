...
function getDefaultPlayer() {
    return {
        ...
        darkness: {bestDecrementy: D(0), levels: Array(3).fill(0), negativeCharge:0, drains: Array(7).fill(0), currentLight: 0, bestEntropy: 0, totalDrains: 0, negativeChargeSpent:0, depth: 0, bestDepth: 0, negativeChargeEnabled:false, darkened:false},
