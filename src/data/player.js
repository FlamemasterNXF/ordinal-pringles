...
function getDefaultPlayer() {
    return {
        ...
        hyper: { hasUpgrade: Array(hyperChargeUpgradeData.length).fill(false), isUpgradeSecondary: Array(hyperChargeUpgradeData.length).fill(false), shouldForceStable: Array(hyperChargeUpgradeData.length).fill(false) },
