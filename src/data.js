...
const VERSION_DATE = "August 30th, 2023"
const IS_BETA = true
...
function getDefaultObject() {
    return {
        ...
        incrementy: {amt:D(0), hasIUP:Array(12).fill(false), rebuyableAmt: Array(3).fill(0), charge:0, totalCharge:0},
        ...
        omega:{remnants: 0, alephOmega:1, bestFBInPurification: Array(4).fill(0), purificationIsActive: Array(4).fill(false), whichPurification: -1, aoRebuyables:Array(8).fill(0)},
