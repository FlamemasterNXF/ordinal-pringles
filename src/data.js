...
function getDefaultObject() {
    return {
        ...
        destab: {amt: 0, total: 0, times: 0, hasBUP: Array(12).fill(false), isShattered: Array(12).fill(false), unlocks: Array(4).fill(false), completions: Array(6).fill(0), chalActive: -1, incrementy: 0, rupLevels: Array(3).fill(0), hasUpgrade: Array(11).fill(false)},
